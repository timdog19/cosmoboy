                ...
                <Grid container spacing={40}>
                    <Grid item xs={12} sm={12} md={12} lg={6} display="flex" style={{ "align-self": "center" }}>
                        ...
                        <div className={classes.buttoncontainerbreakpoint} mt="10rem" ref={el => buttons = el}>
                            <Box display="inline">  
                                <Button href="https://opensea.io/" variant="contained" color="secondary" className={classes.buttonbreakpoint} style={{ "transform": "scale(1.5)", "transform-origin": "left", "margin-right": "8rem"}}>
                                    BUY ON OPENSEA
                                </Button>
                            </Box>
                            <Box display="inline">                        
