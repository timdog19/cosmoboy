                ...
                <Grid item xs={12} md={12} lg={3} className={classes.footerbreakpoint} justifyContent="space-evenly" alignItems="center">
                  <Stack>
                    ...
                    <Stack direction="row" spacing={1}>
                      <IconButton color="inherit" href="https://twitter.com/"> <FontAwesomeIcon icon={faTwitter}/> </IconButton>
                      <IconButton color="inherit" href="https://instagram.com/"> <FontAwesomeIcon icon={faInstagram}/> </IconButton>
                      <IconButton color="inherit" href="https://github.com/"> <FontAwesomeIcon icon={faGithub}/> </IconButton>
                      <IconButton color="inherit" href="https://discord.com/"> <FontAwesomeIcon icon={faDiscord}/> </IconButton>
                    </Stack>
                  </Stack>
                </Grid>
