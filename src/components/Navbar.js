      ...
      <AppBar position="fixed" color="transparent" elevation={0} className={navbar ? "custom-appbar active" : "custom-appbar"}>
        <Toolbar>
          <Typography variant="h6" color="light" className={classes.grow}>
            ...
            <IconButton className={classes.desktop} color="inherit" href="https://twitter.com/"> <FontAwesomeIcon icon={faTwitter}/> </IconButton>
            <IconButton className={classes.desktop} color="inherit" href="https://instagram.com/"> <FontAwesomeIcon icon={faInstagram}/> </IconButton>
            <IconButton className={classes.desktop} color="inherit" href="https://github.com/"> <FontAwesomeIcon icon={faGithub}/> </IconButton>
            <IconButton className={classes.desktop} color="inherit" href="https://discord.com/"> <FontAwesomeIcon icon={faDiscord}/> </IconButton>
